 ...
 */
void ssd1306_drawImage(int x, int y, const unsigned char *input, uint8_t width,
                       uint8_t height, uint8_t color_mode) {
  int x_absolute;
  int y_absolute;
  uint8_t pixel;
 ...
 */
int16_t gfx_abs(int16_t x) { return (x < 0) ? -x : x; }
 ...
 */
void ssd1306_drawchar_sz(uint8_t x, uint8_t y, uint8_t chr, uint8_t color,
 ...
 */
void ssd1306_drawstr_sz(uint8_t x, uint8_t y, char *str, uint8_t color,
                        font_size_t font_size) {
  uint8_t c;
